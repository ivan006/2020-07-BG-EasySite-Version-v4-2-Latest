        ...
        if ($data_item_value['type'] !== "report" AND $data_item_value['type'] !== "section") {
          ...
          if ("old"=="old.") {
            ...
            <!-- <div style="" class=" "> -->
              ...
              <!-- <div class="rounded PaV_0p5rem" style="border: solid 1px Gainsboro;"> -->
              <div class="PaV_0p5rem" style="border-top: solid 1px Gainsboro; border-bottom: solid 1px Gainsboro;">
                <?php echo $report_object->show_html_helper($data_item_value["content"], $LayerNumber, $nestlevel_count_new) ?>
              </div>
